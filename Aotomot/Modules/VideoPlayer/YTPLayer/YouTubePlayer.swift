...
public func videoIDFromYouTubeURL(_ videoURL: URL) -> String? {
  if let validUrl = videoURL.host?.hasSuffix("youtu.be"){
    if videoURL.pathComponents.count > 1 && validUrl {
...
open class YouTubePlayerView: UIView, UIWebViewDelegate {
    ...
    open func loadVideoURL(_ videoURL: URL)->(Bool) {
...
//        playerParams["controls"] = 0 as AnyObject
//
    ...
    open func unMute() -> String? {
        return evaluatePlayerCommand("unMute()")
    }
    ...
    open func pause() -> String? {
        return evaluatePlayerCommand("pauseVideo()")
    }
    
    open func stop() -> String? {
       return evaluatePlayerCommand("stopVideo()")
    }
    
    open func clear() -> String? {
        return evaluatePlayerCommand("clearVideo()")
    }
    
    open func seekTo(_ seconds: Float, seekAhead: Bool) -> String? {
        return evaluatePlayerCommand("seekTo(\(seconds), \(seekAhead))")
    }
    ...
    open func previousVideo() -> String? {
        return evaluatePlayerCommand("previousVideo()")
    }
    
    open func nextVideo() -> String? {
        return evaluatePlayerCommand("nextVideo()")
    }
